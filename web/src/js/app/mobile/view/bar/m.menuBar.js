...
var { MMBtn_map } = require('@/app/class/c.simpleElements');

var { bQuestList } = require('@/app/view/town/questlist');
var { bMMenu_trade, bShortMainMenu, bSMMenu_btns, bMMenu_luck, bMMenu_pop, bMMenu_attacks } = require('@/app/view/town/mainmenu');
...
var { Ability } = require('@/app/class/c.ability');
var { Vector2D } = require('@/app/class/c.math');
var { Quest } = require('@/app/class/c.quest');
