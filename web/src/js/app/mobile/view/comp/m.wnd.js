...
function OriginContentWnd(contOrTmpl, options){
...
utils.overrideMethod(Wnd, 'setParams', function __method__(params){
	params = params||{};
    
    this.__initSwipeOpt = params.__initSwipeOpt;
}, constChildren);
...
utils.overrideMethod(Wnd, 'prepareIdentWnd', function __method__(identWnd){
    if( this.__initSwipeOpt )
        identWnd.__initSwipeOpt = this.__initSwipeOpt;
        ...
        Wnd.prototype.bindSwipe = function(){
            ...
            this.$wrp
                ...
                .on('touchmove', '.wnd-cont-wrp', function(e){
                    ...
                    if( self.swipe )
                        self.trySwipeMove(touches, e);
                    else
                        self.touchMove(e);
                })
                .on('touchend touchcancel', '.wnd-cont-wrp',function(e){
                    self.swipeEnd();
...
Wnd.prototype.cacheCont = function(){
    ...
    this.contWrp = this.$contWrp.get(0);
...
utils.overrideMethod(Wnd, 'onIdentShow', function __method__(){
    var opt = {wndIdent: true};
    
    utils.copy(opt, this.__initSwipeOpt);
    
    delete this.__initSwipeOpt;
    
	wndMgr.swipeWnd(this, opt);
}, constChildren);

utils.overrideMethod(Wnd, 'onFirstShow', function __method__(){
    var opt = {noResize: true};
...
Wnd.prototype.setContWrpSize = function(wndSize){
    ...
    Wnd.prototype.getContWrpWidth = function(){
        return this.contWrpSize.width;
    };
    
    Wnd.prototype.getContWrpHeight = function(){
        return this.contWrpSize.height;
    };
...
Wnd.prototype.allowDeleteWrp = function(){
	...
	return !wndMgr.isSwiping() || this.isContHidden() || (backWnd && backWnd != this);
};
...
Wnd.prototype.swipeStar = function(opt){
	...
	Wnd.prototype.trySwipeMove = function(touches, e){
...
Wnd.prototype.doSwipe = function(swipe, dir, swipeTime){
	if( swipe.$trigger ){
		if( swipe.dir < 0 )
	...
	wndMgr.swipeWnd(swipe.nextWnd, {dir: dir, noPrepare: true});
};
...
Wnd.prototype.resetSwipe = function(){
	...
	this.onSwipeReset(this.swipe.nextWnd);
};
...
Wnd.prototype.touchStar = function(e){};

Wnd.prototype.touchMove = function(e){};

Wnd.prototype.touchEnd = function(e){};
...
Wnd.prototype.onSwipeReset = function(nextWnd){};

Wnd.prototype.onSwipeBack = function(nextWnd){};
...
module.exports = {OriginWnd, ScreenWnd, InfScreenWnd};
