...
var { Panel } = require('@/app/view/comp/panel');
...
Panel.prototype.afterAllShow = function(){
    ...
    Panel.prototype.setSwipeHandler = function(){
        snip.swipeHandler(this.$contBlk, this.getSwipeHandlerOpt());
    };
        
        Panel.prototype.getSwipeHandlerOpt = function(){
            ...
            return {
                ...
                callbacks: {
                    ...
                    onSwipeEnd: function(pointDelta, swiping){
                        swiping.context.doSwipe(pointDelta);
                    }
                }
            };
        };
...
Panel.prototype.notifToggleExpand = function(expanded, notif, opt){
    return this.toggleExpand(expanded, opt);
};
...
var { Vector2D } = require('@/app/class/c.math');
