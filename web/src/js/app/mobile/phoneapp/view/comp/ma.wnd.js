...
var { ScreenWnd } = require('@/app/mobile/view/comp/m.wnd');
...
utils.overrideMethod(Wnd, 'trySwipeMove', function __method__(touches, e){
...
utils.overrideMethod(Wnd, 'doSwipe', function __method__(swipe, dir){
    ...
    wndMgr.swipeWnd(nextWnd, {dir: dir});
...
ScreenWnd.prototype.trySwipeMove = Wnd.prototype.trySwipeMove.origin;
...
ScreenWnd.prototype.onSwipeReset = function(nextWnd){
    nextWnd.close();
};

ScreenWnd.prototype.onSwipeBack = function(nextWnd){
    nextWnd.close();
};
